...
def prepare_htmls(normalPath, reversePath, baseFileName, directory):
    with open("resources/source.html") as f:
        htmlCode = f.read()
...
if __name__ == '__main__':
    for ps in range(PRACTICE_SETS_NEEDED):
        ...
        shutil.copytree(os.path.join("resources", "js"), os.path.join(directory, "js"))
        shutil.copyfile(os.path.join("resources", "a_logo.png"),os.path.join(directory, "a_logo.png"))
        shutil.copyfile(os.path.join("resources", "style.css"), os.path.join(directory, "style.css"))
        ...
        for file in os.listdir('project/'):
            ...
            print(questionFilePath, questionFilePathReversed, baseFileName)
        ...
        #print("please access acharvita.html file now!")
